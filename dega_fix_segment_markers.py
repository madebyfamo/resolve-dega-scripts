...
def main():
    ...
    PRINCIPLES_MARKERS = [
        (
            ...
            "Purple",
            "Range 0-∞s. Your core workflow guidance for segment-based content.",
        ),
        (
            1.0,
            "Micro-jolt cadence",
            "Pink",
            "Every 3–5s, introduce a small visual/audio shift to maintain retention.",
        ),
        (
            2.0,
            "Loop seam awareness",
            "Yellow",
            "Plan edit around clean loop point (if needed) for repeatable shorts.",
        ),
